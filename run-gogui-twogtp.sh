...
P1B='./nogo --shell --name="mcts" --black="name=mcts thread=1 c=0.3 k=10 time=0.5 skip=1"'
P1W='./nogo --shell --name="mcts" --white="name=mcts thread=1 c=0.3 k=10 time=0.5 skip=1"'
